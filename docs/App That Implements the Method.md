...
| /api/habits/\<id\> | Edit existing habit                              | New field values (a "dict update" is performed)  | Error code                                                                                                | POST   |
...
| /api/timing/\<id\> | Set new current time for habit                   | New current time for habit                       |                                                                                                           | POST   |
|                    |                                                  |                                                  |                                                                                                           |        |
...
## Main Screen
Where you can see the habits available to be performed, separated in to two groups (daily and weekly)
